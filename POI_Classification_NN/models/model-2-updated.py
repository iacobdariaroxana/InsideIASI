...
train_path = '../vgg16-dataset-updated2/train'
val_path = '../vgg16-dataset-updated2/val'
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath=f'Model/{filename}2-epoch_' + '{epoch:02d}',
                                       save_freq='epoch')
]
...
np.save(f'History/{filename}2-history.npy', history.history)
