...
train_dataset = tf.keras.preprocessing.image_dataset_from_directory(
    '../final_prepdata/train', batch_size=64, image_size=(256, 341))
...
callbacks = [
    tf.keras.callbacks.ModelCheckpoint(filepath=f'Model/{filename}-last-epoch_' + '{epoch:02d}',
                                       save_freq='epoch')
]
...
np.save(f'History/{filename}-last-history.npy', history.history)
